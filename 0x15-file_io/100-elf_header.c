 ...
 *
 * Description: If file is not an ELF file - exit the code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_magic - Prints magic numb of an ELF header.
 * @e_ident: A pointer to an array contain ELF magic numbers.
 *
 ...
 * @e_ident: A pointer toarray containing ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
 ...
 * @e_type: The ELF type.
 * @e_ident: A pointer an array containing ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * print_entry - Printsentry point of an ELF header.
 ...
 *
 * Description: If file cannot be closed - exit the code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * the function fails - exit the code 98.
 */
